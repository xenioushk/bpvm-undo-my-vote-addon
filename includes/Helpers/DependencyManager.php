...
class DependencyManager {
	...
	private static function set_urls() {
		...
		self::$addon_title      = '<strong>Undo My Vote Addon For BWL Pro Voting Manager</strong>';
	}
	...
	private static function set_dependency_constants() {
		define( 'UMVADDON_MIN_BPVM_VERSION', '1.4.5' );
		define( 'UMVADDON_MIN_PHP_VERSION', '7.0' );
	}
	...
	public static function check_minimum_version_requirement_status() {
		...
		return ( version_compare( BPVM_CURRENT_PLUGIN_VERSION, UMVADDON_MIN_BPVM_VERSION, '>=' ) );
	}
